...
const { refreshKongTokenSession } = require('../helpers/kongTokenHelper');
...
module.exports = (app, keycloak) => {
  ...
  session({
    ...
    store: memoryStore
  }), keycloak.middleware({ admin: '/callback', logout: '/logout' }), keycloak.protect(), refreshKongTokenSession(), indexPage(true));
